...
public class EditBooking {
	...
	public void Edit() throws IOException, ParseException {
		...
		System.out.println("Please input the Email Address associated with the booking you wish to edit:");
		...
		System.out.println("Please input the Booking ID of the reservation you wish to edit:");
		...
		System.out.println("Please confirm these are the correct details of the booking you wish to edit:\n");
		...
		while(confirmDeletion == false) {
			...
			if(choice.contentEquals("YES")) {
				...
				System.out.println("\nEditing Cancelled. Returning you to Edit Booking Screen.\n");
				Edit();
				return;
			}
